	...
	<div style="background-color:#eef1f4">
		...
		<div style="margin-top:20px;max-width:600px">
			<div style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%">
				...
				<div style="margin-bottom:10px;margin-top:40px;font-family:Nunito Sans,Arial;font-size:16px;line-height:22px;text-align:left;color:#43425d">
		...
		<div style="height:50px;font-family:Nunito Sans,Arial;font-size:12px;line-height:16px;text-align:center;color:#8b95a5">
			ENDERECO_EMPRESA
		</div>
	</div>
</div>
